...
class ErrorHandler implements Exception {
  ...
  ErrorHandler.handle(dynamic error) {
    if (error is DioError) {
      //dio error its from response API
...
class ResponseMessage {
  ...
  static const String UNAUTHORISED =
      'User is unathorised, try again later'; //failure user not authorised
  static const String NOT_FOUND =
      'Url not found, try again later'; //failure, api url is not correct and not found
  static const String INTERNAL_SERVER_ERROR =
      'Something wrong, try again later'; //failure, crash happened in server side

  //local status code
  static const String DEFAULT = 'Something wrong, try again later';
